...
<main id="main">
  ...
  <div class="container">
    <div class="service-nav-fix">
      <div class="row">
        <div class="col-4">
         <div class="list-group" id="list-tab" role="tablist">
            <a class="list-group-item list-group-item-action active" id="list-home-list" data-toggle="list" href="#Stratégie" role="tab" aria-controls="home">Stratégie</a>
            <a class="list-group-item list-group-item-action" id="list-profile-list" data-toggle="list" href="#Finance" role="tab" aria-controls="profile">Finance</a>
            <a class="list-group-item list-group-item-action" id="list-messages-list" data-toggle="list" href="#Qualité" role="tab" aria-controls="messages">Qualité</a>
            <a class="list-group-item list-group-item-action" id="list-settings-list" data-toggle="list" href="#Commercial" role="tab" aria-controls="settings">Commercial</a>
            <a class="list-group-item list-group-item-action" id="list-settings-list" data-toggle="list" href="#Marketing" role="tab" aria-controls="settings">Marketing</a>
            <a class="list-group-item list-group-item-action" id="list-settings-list" data-toggle="list" href="#Ressources-Humaines" role="tab" aria-controls="settings">Ressources Humaines</a>
            <a class="list-group-item list-group-item-action" id="list-settings-list" data-toggle="list" href="#Achat-Approvisionnement" role="tab" aria-controls="settings">Achat & Approvisionnement</a>
            <a class="list-group-item list-group-item-action" id="list-settings-list" data-toggle="list" href="#Logistique" role="tab" aria-controls="settings">Logistique</a>
            <a class="list-group-item list-group-item-action" id="list-settings-list" data-toggle="list" href="#Production" role="tab" aria-controls="settings">Production</a>
          </div>
        </div>
        <div class="col-8">
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade in active" id="Stratégie" role="tabpanel" aria-labelledby="list-home-list">
              <div class="coool">
              ...
              <img src="assets/img/compétences/strategie.jpg" class="rounded float-right" style="width: 250px; height: 170px" alt="" />
            </div>
            <div class="tab-pane fade" id="Finance" role="tabpanel" aria-labelledby="list-profile-list">
              ...
              <img src="assets/img/compétences/finance.jpg" class="rounded float-right" style="width: 150px; height: 100px" alt="" />
            ...
            <div class="tab-pane fade" id="Qualité" role="tabpanel" aria-labelledby="list-messages-list">
              <div class="coool">
                ...
                <ul style="text-align: left; margin-left: 10%">
                  ...
                  <li type="square">ISO 9001 V 2008.</li>

                  <li type="square">ISO 22000 V 2005.</li>
                  <li type="square">ISO 14001 V 2004.</li>
                  <li type="square">OHSAS 18001 V 2007.</li>

                  <li type="square">ISO 17025 V 2005.</li>
                  <li type="square">Les Normes Marocaines (NM).</li>
                </ul>
              </div>
              <img src="assets/img/compétences/qualite.jpg" class="rounded float-right" style="width: 250px; height: 170px" alt="" />
            ...
            <div class="tab-pane fade" id="Commercial" role="tabpanel" aria-labelledby="list-settings-list">
              ...
              <img src="assets/img/compétences/commercial.jpg" class="rounded float-right" style="width: 250px; height: 170px" alt="" />
            ...
            <div class="tab-pane fade" id="Marketing" role="tabpanel" aria-labelledby="list-settings-list">
              ...
              <img src="assets/img/compétences/marketing.png" class="rounded float-right" style="width: 250px; height: 170px" alt="" />
            ...
            <div class="tab-pane fade" id="Ressources-Humaines" role="tabpanel" aria-labelledby="list-settings-list">
              ...
              <img src="assets/img/compétences/production.jpg" class="rounded float-right" style="width: 250px; height: 170px" alt="" />
            ...
            <div class="tab-pane fade" id="Achat-Approvisionnement" role="tabpanel" aria-labelledby="list-settings-list">
              ...
              <img src="assets/img/compétences/achat.jpg" class="rounded float-right" style="width: 250px; height: 170px" alt="" />
            </div>
            <div class="tab-pane fade" id="Logistique" role="tabpanel" aria-labelledby="list-settings-list">
              ...
              <img src="assets/img/compétences/logistique.jpg" class="rounded float-right" style="width: 250px; height: 170px" alt="" />
