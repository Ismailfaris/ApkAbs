        ...
        <!-- ======= Header ======= -->
            <header class="container" id="header">
                ...
                <nav id="navigation" class="navbar-expand-lg">
                    <a class="navbar-toggler" style="color:#FFF" type="button" data-bs-toggle="collapse" href="#collapsedNavbar" role="button" aria-expanded="false" aria-controls="collapsedNavbar" aria-label="Toggle navigation">
                        X
                    </a>
